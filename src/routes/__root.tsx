  ...
  head: () => ({
    meta: [
      ...
      { title: "Harsh Singh — Senior Python Backend Developer" },
      {
        name: "description",
        content:
          "Harsh Singh — Senior Python Backend Developer. FastAPI, Django, Microservices, AWS, Docker, PostgreSQL. 4+ years building enterprise MES, WMS and AI platforms.",
      },
      { name: "author", content: "Harsh Singh" },
      { name: "theme-color", content: "#000000" },
      { property: "og:title", content: "Harsh Singh — Senior Python Backend Developer" },
      { property: "og:description", content: "Enterprise backend, microservices, cloud-native & AI systems." },
